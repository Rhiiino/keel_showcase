...
- (backend) Restored `backend/scripts/db/demo/` after DB bootstrap consolidation — keeps the showcase demo seed runnable on hetzone without reintroducing removed migrations or dev scripts.
