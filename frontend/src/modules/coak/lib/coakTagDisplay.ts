// keel_web/src/modules/coak/lib/coakTagDisplay.ts

export const DEFAULT_COAK_TAG_COLOR = "#06B6D4";

export const COAK_TAG_PILL_TEXT_COLOR = "#FAFAF9";
...
export function coakTagPillStyle(colorHex: string): {
  ...
  return {
    ...
    color: COAK_TAG_PILL_TEXT_COLOR,
