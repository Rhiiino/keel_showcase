// keel_web/src/modules/shop/components/VendorLogoMenu.tsx

// Three-dot menu for vendor logo with navigation to media detail.
...
type VendorLogoMenuProps = {
  disabled?: boolean;
  onViewMedia: () => void;
  className?: string;
};

export function VendorLogoMenu({
  disabled = false,
  onViewMedia,
  className = "",
}: VendorLogoMenuProps) {
