// keel_web/src/modules/shop/components/tags/FinanceObligationTagListRow.tsx

import { useEffect, useRef, useState, type Ref } from "react";

import { useConfirmDeleteAction } from "../../../../hooks/useConfirmDeleteAction";
import type { FinanceObligationTag } from "../../api";
import { normalizeHexColor } from "../../lib/obligationTagDisplay";
import { CardMenu } from "../../../../components/CardMenu";
import { FinanceObligationTagPill } from "./FinanceObligationTagPill";
...
type FinanceObligationTagListRowProps = {
...
export function FinanceObligationTagListRow({
  tag,
  disabled = false,
  onRename,
  onDescriptionChange,
...
}: FinanceObligationTagListRowProps) {
  ...
  const previewTag: FinanceObligationTag = {
    ...tag,
  ...
  return (
    ...
    >
      ...
      <div className="flex min-w-0 items-center px-4 py-3.5">
        <FinanceObligationTagPill tag={previewTag} />
      </div>

      <div className="flex items-center justify-center px-4 py-3.5">
        <span className="text-sm tabular-nums text-stone-300">{tag.obligation_count}</span>
      </div>
