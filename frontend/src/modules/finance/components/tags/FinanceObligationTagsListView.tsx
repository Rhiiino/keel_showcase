// keel_web/src/modules/shop/components/tags/FinanceObligationTagsListView.tsx

import type { Ref } from "react";

import { TagsListView } from "../../../../views/list/TagsListView";
import type { FinanceObligationTag } from "../../api";
import { getFinanceObligationTagSortValue } from "../../lib/obligationTagListSort";
import {
  FINANCE_TAG_LIST_GRID_CLASS,
  FINANCE_TAG_LIST_TABLE_WIDTH_CLASS,
  FinanceTagDraftRow,
  FinanceObligationTagListRow,
} from "./FinanceObligationTagListRow";
...
type FinanceObligationTagsListViewProps = {
...
export function FinanceObligationTagsListView({
  tags,
  draftTag = null,
  draftInputRef,
  onDraftNameChange,
  ...
  paginationResetKey,
}: FinanceObligationTagsListViewProps) {
  const draftRow =
  ...
  return (
    <TagsListView
      ...
      showDescription
      getSortValue={getFinanceObligationTagSortValue}
