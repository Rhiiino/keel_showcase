// keel_web/src/modules/shop/components/tags/FinanceTransactionInlineTags.tsx

import { useQuery } from "@tanstack/react-query";
import { useEffect, useMemo, useRef, useState } from "react";

import { fetchFinanceTransactionTags, financeQueryKeys, type FinanceTransactionTag } from "../../api";
import { financeTransactionTagPillStyle } from "../../lib/transactionTagDisplay";

type FinanceTransactionInlineTagsProps = {
  tagIdsDraft: number[];
...
export function FinanceTransactionInlineTags({
  tagIdsDraft,
  onTagIdsDraftChange,
  disabled = false,
}: FinanceTransactionInlineTagsProps) {
  ...
  const selectedTags = tagIdsDraft
    ...
    .filter((tag): tag is FinanceTransactionTag => tag !== undefined);
