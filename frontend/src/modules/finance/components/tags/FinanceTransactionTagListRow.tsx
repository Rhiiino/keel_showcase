// keel_web/src/modules/shop/components/tags/FinanceTransactionTagListRow.tsx

import { useEffect, useRef, useState, type Ref } from "react";

import { useConfirmDeleteAction } from "../../../../hooks/useConfirmDeleteAction";
import type { FinanceTransactionTag } from "../../api";
import { normalizeHexColor } from "../../lib/transactionTagDisplay";
import { CardMenu } from "../../../../components/CardMenu";
import { FinanceTransactionTagPill } from "./FinanceTransactionTagPill";

export const FINANCE_TAG_LIST_TABLE_WIDTH_CLASS = "w-full";

export const FINANCE_TAG_LIST_GRID_CLASS =
  "grid w-full grid-cols-[4.5rem_minmax(0,1fr)_minmax(0,1fr)_minmax(0,1fr)_5rem_3.5rem] items-center";

type FinanceTransactionTagListRowProps = {
...
export function FinanceTransactionTagListRow({
  tag,
  disabled = false,
  onRename,
  onDescriptionChange,
...
}: FinanceTransactionTagListRowProps) {
  ...
  const previewTag: FinanceTransactionTag = {
    ...tag,
  ...
  return (
    ...
    >
      ...
      <div className="flex min-w-0 items-center px-4 py-3.5">
        <FinanceTransactionTagPill tag={previewTag} />
      </div>

      <div className="flex items-center justify-center px-4 py-3.5">
        <span className="text-sm tabular-nums text-stone-300">{tag.transaction_count}</span>
      </div>
...
export function FinanceTagDraftRow({
  name,
  colorHex,
  disabled = false,
  inputRef,
