// keel_web/src/modules/shop/lib/obligationTagDisplay.ts

// Color helpers for obligation tag pills.

export const DEFAULT_FINANCE_OBLIGATION_TAG_COLOR = "#06B6D4";

export const FINANCE_OBLIGATION_TAG_PILL_TEXT_COLOR = "#FAFAF9";
...
export function financeObligationTagPillStyle(colorHex: string): {
  ...
  return {
    ...
    color: FINANCE_OBLIGATION_TAG_PILL_TEXT_COLOR,
