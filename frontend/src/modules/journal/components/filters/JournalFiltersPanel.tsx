// keel_web/src/modules/journal/components/filters/JournalFiltersPanel.tsx

import type { ReactNode } from "react";

type JournalFiltersPanelProps = {
  open: boolean;
