// keel_web/src/modules/journal/lib/journalTagDisplay.ts

// Color helpers for journal tag pills.

export const DEFAULT_JOURNAL_TAG_COLOR = "#06B6D4";

export const JOURNAL_TAG_PILL_TEXT_COLOR = "#FAFAF9";
...
export function journalTagPillStyle(colorHex: string): {
  ...
  return {
    ...
    color: JOURNAL_TAG_PILL_TEXT_COLOR,
