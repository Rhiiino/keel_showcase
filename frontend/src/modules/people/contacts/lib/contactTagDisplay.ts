// keel_web/src/modules/contacts/lib/contactTagDisplay.ts

// Color helpers for contact tag pills.

export const DEFAULT_CONTACT_TAG_COLOR = "#06B6D4";

export const CONTACT_TAG_PILL_TEXT_COLOR = "#FAFAF9";
...
export function contactTagPillStyle(colorHex: string): {
  ...
  return {
    ...
    color: CONTACT_TAG_PILL_TEXT_COLOR,
