// keel_web/src/modules/people/shared/components/PersonPhotoMenu.tsx
...
type PersonPhotoMenuProps = {
  disabled?: boolean;
  onViewMedia: () => void;
  className?: string;
};

export function PersonPhotoMenu({
  disabled = false,
  onViewMedia,
  className = "",
}: PersonPhotoMenuProps) {
    ...
    <>
      ...
      >
        <button
          ...
          aria-expanded={open}
          className={[
            "inline-flex h-6 w-6 items-center justify-center rounded-full bg-stone-950/85 text-stone-200 ring-1 ring-stone-700/80 transition",
            disabled
